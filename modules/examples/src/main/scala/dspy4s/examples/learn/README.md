...
dspy4s keeps domain values throughout. Programs are immutable `ProgramWithEnv[I, O, R]` values, signatures carry
input and output shapes, and results decode into domain outputs. The Scala compiler checks each composition edge and
each required execution service.
