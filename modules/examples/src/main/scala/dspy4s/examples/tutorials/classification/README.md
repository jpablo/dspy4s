...
- Wrap it in `Program.predict` or `ChainOfThought`, evaluate with a metric
  ([`learn/evaluation`](../../learn/evaluation/README.md)), and tune demos with `BootstrapFewShot` or
  `BootstrapRandomSearch` ([`learn/optimization`](../../learn/optimization/README.md)).
