/** Utilizing Built-in Datasets
  *
  * Source: docs/docs/deep-dive/data-handling/built-in-datasets.md Upstream:
  * https://github.com/stanfordnlp/dspy/blob/main/docs/docs/deep-dive/data-handling/built-in-datasets.md Status: blocked
  * (4 python snippets) — dspy4s has no built-in dataset loaders (no `dspy.datasets`, HotPotQA / GSM8K / Color / etc.).
  * Bring your own data via `Example` (see deep_dive/data_handling/LoadingCustomData.scala).
  */
