...
final case class Lift[I, O](run: I => O) extends TransparentModule[ProgramCall[I], Prediction[O]]:
...
final case class MapOutput[I, O, B, P <: Module[ProgramCall[I], Prediction[O]]](program: P, map: O => B)
    extends TransparentModule[ProgramCall[I], Prediction[B]]:
...
object MapOutput:
  given mapOutputPredictors[I, O, B, P <: Module[ProgramCall[I], Prediction[O]]](using
      inner: Predictors[P]
...
final case class ContramapInput[J, I, O, P <: Module[ProgramCall[I], Prediction[O]]](program: P, contramap: J => I)
    extends TransparentModule[ProgramCall[J], Prediction[O]]:
...
object ContramapInput:
  given contramapInputPredictors[J, I, O, P <: Module[ProgramCall[I], Prediction[O]]](using
      inner: Predictors[P]
...
final case class Dimap[J, I, O, B, P <: Module[ProgramCall[I], Prediction[O]]](
    program: P,
    contramap: J => I,
    map: O => B
) extends TransparentModule[ProgramCall[J], Prediction[B]]:
...
object Dimap:
  given dimapPredictors[J, I, O, B, P <: Module[ProgramCall[I], Prediction[O]]](using
      inner: Predictors[P]
