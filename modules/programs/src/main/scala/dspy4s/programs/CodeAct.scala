...
object CodeAct:
  ...
  /** Build a bounded code agent.
    ...
    * Executor infrastructure failures stay in the typed error channel. Extraction runs when the model requests finish
    * after valid code, or after the final allowed iteration.
    */
