...
object ReAct:
  ...
  /** Build a bounded tool-agent program.
    *
    * Generator, tool invocation, and extraction remain ordinary visible programs. Tool failures become trajectory
    * data. The extractor runs after an explicit `Finish` action or after the final allowed invocation.
    */
