...
- **The unit stays `Module[I, Prediction[O]]`.** No parallel `Program` type is introduced (this keeps
...
`Program[I, O]` = `Module[I, Prediction[O]]`. Learnable parts are held as addressable immutable
