...
in the examples module — it compiles under the project's strict flags.

## 1. Declare a signature and a program

A **signature** is a typed input → output contract; a **program** (here
...
the output — no signature changes required:
...
- [Signatures](../learn/programming/signatures.md) — the full set of ways to
  declare inputs and outputs (string DSL, traits, enums, custom types).
